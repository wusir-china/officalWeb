...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/news/add" method=post>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：新闻管理 &gt; 添加新闻</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="content">
								</td>																
							</TR>
							<tr>
								<td>时间 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="dates">
								</td>
							</tr>							
