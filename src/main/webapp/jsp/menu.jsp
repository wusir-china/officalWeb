...
<BODY>
	<FORM id=form1 name=form1 action=YHMenu.aspx method=post>
		<TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0>
			<TBODY>
				<TR>
					<TD width=15><IMG src="${pageContext.request.contextPath }/resources/images/new_005.jpg" border=0></TD>
					<TD align=middle width=180 background=${pageContext.request.contextPath }/resources/images/new_006.jpg
						height=35><B>功能菜单</B></TD>
					<TD width=15><IMG src="${pageContext.request.contextPath }/resources/images/new_007.jpg" border=0></TD>
				</TR>
			</TBODY>
		</TABLE>
		<TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0>
			<TBODY>
				<TR>
					<TD width=15 background=${pageContext.request.contextPath }/resources/images/new_008.jpg></TD>
		...
		<TR>
			<TD class=mainMenu onClick="MenuDisplay('table_1');"><SPAN
				class=span id=table_1Span>＋</SPAN> 招聘信息管理</TD>
		</TR>
		<TR>
			<TD>
				<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
					...
					<TBODY>
		<TR>
			<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/job/toAddPage" 
				target=main>－ 新增岗位</A></TD>
		</TR>
		<TR> 
			<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/job/toListPage"
				target=main>－ 岗位列表</A></TD>
		</TR>
		<!--  
		<TR> 
			<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/job_listpage.action?currentPage=1"
				target=main>－ 分页岗位列表</A></TD>
		</TR>
		-->										
					</TBODY>
				</TABLE>
		...
		<!-- 0.1.新闻管理-->
		<TR>
			<TD background=${pageContext.request.contextPath }/resources/images/new_027.jpg height=1></TD>
		</TR>
		<TR>
			<TD class=mainMenu onClick="MenuDisplay('table_7');"><SPAN
				class=span id=table_7Span>＋</SPAN> 新闻管理</TD>
		</TR>
		...
		<TR>
			<TD>
				<TABLE id=table_7 style="DISPLAY: none" cellSpacing=0
					...
					<TBODY>
						<TR>
							<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/news/toAddPage"
								target=main>－新增新闻</A></TD>
						</TR>
						<TR>
							<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/news/toListPage"
								target=main>－新闻列表</A></TD>
						</TR>
						<!--<TR> 
							<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/news_listpage.action?currentPage=1"
								target=main>－ 分页新闻列表</A></TD>
						</TR>												
						-->
				</TBODY>
			</TABLE>
		...
		<TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0>
			<TBODY>
				<TR>
					<TD width=15><IMG src="${pageContext.request.contextPath }/resources/images/new_010.jpg" border=0></TD>
					<TD align=middle width=180 background=${pageContext.request.contextPath }/resources/images/new_011.jpg height=15></TD>
					<TD width=15><IMG src="${pageContext.request.contextPath }/resources/images/new_012.jpg" border=0></TD>
				</TR>
			</TBODY>
		</TABLE>
	</FORM>
