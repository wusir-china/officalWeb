...
<!--http://localhost:8080/huawangManager/news_add.action -->
<META content="MSHTML 6.00.2900.3492" name=GENERATOR>
</HEAD>
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/job/add" method=post>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>						  
							...
							<TR>
								...
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="jobName">
								</td>																
							</TR>
							<tr>
								<td>岗位职责 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="duty">
								</td>
							</tr>
							<TR>
								...
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="senior">
								</td>
								<td></td>
								<td>
								</td>
