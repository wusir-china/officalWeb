...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/job/listCondition"
		method=post>
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="jobName"></TD>
	...
	<TR
		...
		<TD>
			...
			<a href="${pageContext.request.contextPath }/job/delete?id=${job.id}">删除</a>
			
			<a href="${pageContext.request.contextPath }/job/toEditPage?id=${job.id}">修改</a>
		</TD>
	</TR>
