...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/news/listCondition"
		method=post>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：新闻管理 &gt; 新闻列表</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="content"></TD>
	...
	<TR
		...
		<TD>${news.dates }</TD>		
		<TD>
			<%-- <input type="button" value="修改" onclick="update('${customer.cid }');"/> --%>
			<a href="${pageContext.request.contextPath }/news/delete?id=${news.id}">删除</a>
			
			<a href="${pageContext.request.contextPath }/news/toEditPage?id=${news.id}">修改</a>
		</TD>
	</TR>
